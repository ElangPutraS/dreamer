        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.updateClass',$kelass->id) }}" >
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('kategori') ? ' has-error' : '' }} form-group{{ $errors->has('kuota') ? ' has-error' : '' }}">
                            <div class="col-md-5">
                                ...
                                <select id="kategori" name="kategori" required autofocus>
                                  <option value="Android" @if($kelass->kategori == "Android")selected @endif>Android</option>
                                  <option value="Website" @if($kelass->kategori == "Android")selected @endif>Website</option>
                                  <option value="Desktop" @if($kelass->kategori == "Android")selected @endif>Desktop</option>
                                </select>
                            ...
                            <div class="col-md-5">
                                ...
                                <br>
                                <input id="kuota" type="number" class="form-control" name="kuota" value="{{$kelass->kuota}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('nama_kelas') ? ' has-error' : '' }}">
                            <div class="col-md-10">
                                ...
                                <br>
                                <input id="nama_kelas" type="text" class="form-control" name="nama_kelas" value="{{$kelass->nama_kelas}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('mulai') ? ' has-error' : '' }} form-group{{ $errors->has('selesai') ? ' has-error' : '' }}">
                            <div class="col-md-5">
                                ...
                                <br>
                                <input id="mulai" type="date" name="mulai" class="form-control" value="{{$kelass->mulai}}" required autofocus>
                            ...
                            <div class="col-md-5">
                                ...
                                <br>
                                <input id="selesai" type="date" class="form-control" name="selesai" value="{{$kelass->selesai}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('dana_dibutuhkan') ? ' has-error' : '' }} form-group{{ $errors->has('uang_registrasi') ? ' has-error' : '' }}">
                            <div class="col-md-5">
                                ...
                                <br>
                                <input id="dana_dibutuhkan" type="number" class="form-control" name="dana_dibutuhkan" value="{{$kelass->dana_dibutuhkan}}" required autofocus>
                            ...
                            <div class="col-md-5">
                                ...
                                <br>
                                <input id="uang_registrasi" type="number" class="form-control" name="uang_registrasi" value="{{$kelass->uang_registrasi}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('deskripsi') ? ' has-error' : '' }}">
                            <div class="col-md-10">
                                ...
                                <br>
                                <textarea rows="4" id="deskripsi" class="form-control" name="deskripsi" required autofocus>{{$kelass->deskripsi}}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('tes_peserta') ? ' has-error' : '' }} form-group{{ $errors->has('tes_pemateri') ? ' has-error' : '' }}">
                            <div class="col-md-5">
                                ...
                                <br>
                                <input id="tes_peserta" type="file" name="tes_peserta" value="{{$kelass->tes_peserta}}">
                            ...
                            <div class="col-md-5">
                                ...
                                <br>
                                <input id="tes_pemateri" type="file" name="tes_pemateri" value="{{$kelass->tes_pemateri}}" >
